...
export default function Sidebar({ type = 'default', image, onClose, username }) {
  ...
  const [showLogs, setShowLogs] = useState(false); // 控制显示
      ...
      <div className="sidebar-content">
        {type === 'location' ? (
          ...
          <>
            ...
            {/* 展示日志条目 */}
            {showLogs && (
              <div className="log-list" style={{ marginTop: '1rem', maxHeight: '300px', overflowY: 'auto' }}>
                <h4>📓 日志条目</h4>
                {logDetails.map((log, idx) => (
                  ...
                  >
                    <div className="log-content">
                      <div><strong>📍 地点：</strong>{log.location_name}</div>
