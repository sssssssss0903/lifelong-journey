...
import Sidebar from '../components/Sidebar';   // ⬅ 从 components 引入
import AddPanel from './AddPanel';             // ⬅ 同级 pages 目录
import '../styles.css';                        // ⬅ 从 src 根目录引入
...
export default function Home({ username }) {
  ...
  const fetchLogs = async () => {
    if (!username) return;
    try {
      // ✅ 改成 RESTful: GET /api/users/:username/logs
