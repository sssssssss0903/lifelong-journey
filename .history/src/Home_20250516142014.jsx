...
useEffect(() => {
  ...
  markedRegions.forEach(log => {
    ...
    // 点击标记弹出信息窗体（你可以换成 UI 弹窗）
    const infoWindow = new window.AMap.InfoWindow({
      content: `
        <div style="width:200px">
          <strong>${log.location_display_name || log.location_name}</strong><br/>
          ${log.content ? log.content.slice(0, 50) + '...' : ''}
          <br/>
          ${log.image_path ? `<img src="${log.image_path}" width="100%">` : ''}
        </div>
      `,
